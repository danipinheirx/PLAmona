...
<head>
	<title>PlaMoNA | Esqueci minha senha </title>
</head>
	...
	<div id="container">
        ...
        <div id="linhas">
           ...
           <div id="adm_add"> 
                <center>
                <div id="area_form"> 
                <form action="email_script/recuperar_senha_script.php" id="formulario1" method="POST" autocomplete="on">
                    <fieldset>
                    <center><legend> Solicitar alteração de senha </legend> </center>
                        <br>
                        <label> Digite seu e-mail: <br> <br> </label> 
                            <input class="campo_nome" type="email" name="email" maxlength=80 required> <br><br>
                         <br> <br> 
...
-->
                        ...
                        <input class="botao_enviar_pequeno" name="enviar" type="submit" value="Enviar recuperação">
                        <br>
                    </fieldset>
                </form>
                </div> </center>
