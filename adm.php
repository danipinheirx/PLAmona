...
<head>
	<title>PlaMoNA | Cadastrar administrador</title>
</head>
	...
	<div id="container">
        ...
        <div id="linhas">
           ...
           <div id="adm_add"> 
                <center>
                <div id="area_form"> 
                <form action="adm_add_script.php" id="formulario1" method="POST" autocomplete="on">
                    <fieldset>
                    <legend> Cadastre um novo administrador </legend> 
                        <br>
                        <label> Nome: <br> </label> 
                        
                            <input class="campo_nome" type="text" name="nome" maxlength=80 required> <br><br>
                        <label> E-mail: <br> </label> 
                            <input class="campo_email" type="email" name="email" placeholder="exemplo@exemplo.com" required> <br> <br>
                        <label> Senha para primeira conexão: <br> </label>
                            <input class="campo_senha" type="password" name="senha" placeholder="*********" required> <br> <br>
                        ...
                        <label> Celular: <br> </label>
                            <input class="campo_telefone" type="text" onkeypress="mascara(this, '## #####-####')" name="telefone" placeholder="(xx)xxxxx-xxxx" maxlength=13 required> <br> <br> 
                        <label> CPF: <br></label>
                            <input class="campo_cpf" type="text" name="cpf" onkeypress="mascara(this, '###.###.###-##')" placeholder="Digite somente números" maxlength="14" required> <br> <br> 
...
-->
                        ...
                        <input class="botao_enviar" name="enviar" type="submit" value="Cadastrar Administrador">
                        <br>
                    </fieldset>
                </form>
                </div> </center>
