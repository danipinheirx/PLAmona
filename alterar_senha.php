...
<head>
	<title>PlaMoNA | Alteração de senha </title>
</head>
	...
	<div id="container">
        ...
        <div id="linhas">
           ...
           <div id="adm_add"> 
                <center>
                <div id="area_form"> 
                <form action="alterar_senha_script.php" id="formulario1" method="POST">
                    <fieldset>
                    <legend> Alterar sua senha</legend> 
                        <br>
                        <label> Senha atual: <br> </label> 
                        <input class="campo_nome" type="password" name="antiga" maxlength=80 required> <br> 
                        <?php 
                            if (isset($_GET['cod'])) {
                                {
                                    $erro = $_GET['cod'];
//                                    echo $erro;
                                    if ($erro == 1){ 
                                        echo "<br> <br> <font color='red'> Senha incorreta! </font> "; 
                                    } 
                        ...
                        <label> Nova senha: <br> </label> 
                            <input class="campo_email" type="password" name="nova"  required> <br> <br>
                         <br> <br> 
