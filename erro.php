...
<body onresize="funcaoResize()">
	...
	<div id="container">
        ...
        <div id="linhas">
                ...
                <div id="construcao"> 
                    <img src="images/logo_plamona_escuro2.png" width="160px" height="195px" align="left"> <br> <br> <br> <br> <center>  ESTA PÁGINA ESTÁ EM CONSTRUÇÃO!  <br> <br> 
                Volte em alguns dias.</div> </center> 
